    ...
    <div className='bg-[linear-gradient(-180deg,#f53d2d,#f63)] pb-5 pt-2 text-white'>
      <div className='container'>
        ...
        <div className='mt-3 grid grid-cols-12 items-end gap-5'>
          ...
          <form className='col-span-9' onSubmit={onSubmitSearch}>
            <div className='flex rounded-lg bg-white p-1'>
              <input
                ...
                {...register('name')}
              />
              <button className='hover:opcacity-90 flex-shrink-0 rounded-lg bg-orange px-6 py-2'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
          ...
          <div className='cols-span-1 justify-seft-end m-2'>
            <Popover
                          ...
                          <div className='mt-2 flex py-2 hover:bg-gray-50' key={purchase._id}>
                            <div className='flex-shrink-0'>
                              <img
                                ...
                                alt={String(purchase.product.name)}
                                className='h-11 w-11 object-cover'
                              />
                            </div>
                            <div className='ml-2 flex-grow overflow-hidden'>
                              <div className='truncate'>{String(purchase.product.name)}</div>
                            </div>
