...
import { formatCurrency, formatNumberToSocialStyle, getIdFromId, rateSale } from 'src/utils/utils'
DOMPurify
...
export default function ProductDetail() {
  ...
  const id = getIdFromId(nameId as string)
  ...
  return (
    <div className='bg-gray-100 py-6'>
        ...
        <div className=' bg-white py-4 shadow'>
          <div className='grid grid-cols-12 gap-9'>
                ...
                {currentImages.map((img) => {
                  ...
                  return (
                    <div className='relative w-full pt-[100%]' key={img} onMouseEnter={() => chooseActive(img)}>
                      ...
                      />
                      {isActive && <div className='bor absolute inset-0 border-2 border-orange' />}
                    </div>
                  )
                })}
                <button
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                <div className='ccapitalize text-gray-500'>Số lượng</div>
                <QuantityController
              ...
              <div className='mt-8 flex items-center'>
                ...
                >
                  <svg
                    ...
                    strokeWidth={1.5}
                    stroke='currentColor'
                    className='mr-[10px] h-5 w-5 stroke-orange text-orange'
                  >
                    <path
                      strokeLinecap='round'
      ...
      <div className='mt-'>
        <div className='container'>
          <div className='mt-8 bg-white p-4 text-left shadow'>
      ...
      <div className='mt-8'>
        <div className='container'>
          <div className='text-left font-semibold uppercase text-gray-400'>Có thể bạn cũng thích</div>
          {productData && (
